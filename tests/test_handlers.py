...
@pytest.mark.asyncio
async def test_on_confirmation_ignores_unknown_decision() -> None:
...
@pytest.mark.asyncio
async def test_on_confirmation_expired_id_survives_edit_failure() -> None:
    """Marking an expired confirmation as expired is best-effort — if the
